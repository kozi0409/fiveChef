...
<body>
	...
	<table align="center" border="1" width="" class="table table-hover">
		<tr> <!-- class="table-info" -->
			<td colspan="6" align="center">
				<form action="/postmanage/search.kh" method="get">
				<div align="center">
	...
	<c:forEach items="${cList }" var="community" varStatus="i">
		<tr align="center">
			...
			<td><a href="/postmanage/detail.kh?communityNo=${community.communityNo }&page=${currentPage }">${community.communityTitle }</a></td>
		...
		<tr align="center" height="20">
			<td colspan="6">
				<c:if test="${currentPage != 1 }">
					<a href="/postmanage/${urlVal }.kh?page=${currentPage - 1 }&searchCondition=${searchCondition}&searchValue=${searchValue}" class="btn btn-primary"><</a>
				</c:if>
				<c:forEach var="p" begin="${startNavi }" end="${endNavi }">
					...
					<c:if test="${currentPage ne p }">
						<a href="/postmanage/${urlVal }.kh?page=${p }&searchCondition=${searchCondition}&searchValue=${searchValue}" class="btn btn-light">${p }</a>
					</c:if>
				</c:forEach>
