				...
				<div class="container">
					<div class="row" id="recipe-main">
						...
						<hr id="cutline">
							...
							<a class="btn btn-primary btn-lg col-md-4" id="btn-2" href="/recipemanage/modifyView.kh?recipeNo=${recipe.recipeNo }&page=${page}">수정</a>
							<a class="btn btn-primary btn-lg col-md-4" id="btn-2" onclick="recipeRemove()" href="/recipemanage/remove.kh?recipeNo=${recipe.recipeNo }">삭제</a></c:if> 
							<a class="btn btn-primary btn-lg col-md-4" id="btn-2" href="/recipemanage/${urlVal }.kh?page=${page }&category=${listValue }">리스트</a>
							</div>
							</div>
	...
	<script type="text/javascript">
		...
		function recipeRemove() {
			...
			if(confirm("(관리자) 해당 게시글을 정말 삭제하시겠습니까?")) {
				location.href="/recipemanage/remove.kh?recipeNo=${recipe.recipeNo }";
			}
		}
	</script>
	<footer>
